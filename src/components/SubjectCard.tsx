...
export default function SubjectCard({ subject, index = 0 }: SubjectCardProps) {
    ...
    return (
        <MotionLink
            ...
            whileTap={{ scale: 0.98 }}
            className="group block bg-white rounded-2xl p-5 border border-slate-100 shadow-sm hover:shadow-lg hover:border-blue-100 transition-all"
        >
            <div className="flex items-start justify-between mb-4">
                ...
                <div className="bg-slate-50 px-2 py-1 rounded-lg text-xs font-semibold text-slate-600">
                    {progress}%
                </div>
            </div>
            ...
            <div className="mt-4 flex items-center text-sm font-medium text-slate-400 group-hover:text-slate-600 transition-colors">
